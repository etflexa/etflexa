...
- Desenvolvimento de soluções para **ERP**
- Versionamento com Git (GitHub e Bitbucket)
...
### 🔹 WisdowKeeper
Plataforma web de **gestão de conhecimento** voltada para auxiliar estagiários e equipes de TI na resolução de problemas recorrentes envolvendo ERP.

- 🔧 Stack: React, TailwindCSS, Node.js, MongoDB
- 🌐 Produção: https://wisdowkeeper-o6y5.vercel.app
- 📂 Repositório: https://github.com/etflexa/wisdowkeeper
